...
class CPWaterVolume extends WaterVolume
	placeable;
...
defaultproperties
{
	...
	EntrySound=SoundCue'TA_Character_Footsteps.FootSteps.TA_Character_Footstep_Water_Deep'
	ExitSound=SoundCue'TA_Character_Footsteps.Land.LND_Water_Sh_Cue'

	ProjectileEntryEffect=none //ParticleSystem'Envy_Effects.Particles.P_WP_Water_Splash_Small'
...
//   X will be how much the VH is moving forward or backward.  If the VH is moving full speed forward set X to 5 if it is moving full speed backwards set X to -5.   Y axis is Left and right, Positive will be right negative is left.  Dont have to worry about Z axis.
	...
	PS_EnterWaterEffect_Pawn=none //ParticleSystem'Envy_Level_Effects_2.Vehicle_Water_Effects.P_Player_Water_Impact'
	PS_EnterWaterEffect_Vehicle=none //ParticleSystem'Envy_Level_Effects_2.Vehicle_Water_Effects.P_General_VH_Water_Impact'
}
