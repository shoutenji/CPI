class CPAttachment_MP5A3 extends CPFiringWeaponAttachment;

defaultproperties
{
	WeaponClass=class'CPWeap_MP5A3'
	...
	MuzzleFlashPSCTemplate=ParticleSystem'CP_Juan_FX.Particles.PS_CP_MP5_Muzzle_Flash_3rd'
	MuzzleFlashAltPSCTemplate=ParticleSystem'CP_Juan_FX.Particles.PS_CP_MP5_Muzzle_Flash_3rd'
